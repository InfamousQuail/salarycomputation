...
window.title("Salary Computation")
...
checkboxGsis = tk.Checkbutton(window,variable=checkbox_varGsis, background="#FFDE59", foreground= "#FF5757")
checkboxGsis.place(
    x=220.0, 
    y=330.0,
    width=15.0, 
...
checkboxPagibig = tk.Checkbutton(window,variable=checkbox_varPagibig, background="#FFDE59", foreground= "#FF5757")
...
checkboxPhilhealth = tk.Checkbutton(window,variable=checkbox_varPhilhealth, background="#FFDE59", foreground= "#FF5757")
